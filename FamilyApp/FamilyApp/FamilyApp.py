...
#two = Event.newEvent(person.graphInfo.access_token, person.graphInfo.getTID(),"Test Event", startDateTime=datetime.datetime(2016,7,26,18), endDateTime=datetime.datetime(2016,7,26,19),reminder = True)
#print(two)
